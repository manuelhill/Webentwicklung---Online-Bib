 ...
 * Servlet
 */
@WebServlet("/adminBibliothekServlet")
public class adminBibliothekServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public adminBibliothekServlet() {
        super();
		...
		try {
			...
			while (bookQuery.next()){
				...
				request.setAttribute("id", bookID);
			 	...
			 	RequestDispatcher dispatcher = request.getRequestDispatcher("/jsp/adminBibliothek.jsp");
