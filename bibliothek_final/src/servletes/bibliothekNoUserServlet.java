 ...
 * Servlet
 */
@WebServlet("/bibliothekNoUserServlet")
public class bibliothekNoUserServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public bibliothekNoUserServlet() {
        super();
		...
		try {
			...
			while (bookQuery.next()){
				...
				request.setAttribute("id", bookID);
			 	...
			 	RequestDispatcher dispatcher = request.getRequestDispatcher("/jsp/indexNoUser.jsp");
